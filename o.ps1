...
<LocalAccount wcm:action="add"><Name>$Username</Name><Group>Administrators</Group><Password><Value>$PasswordPlain</Value><PlainText>true</PlainText></Password></LocalAccount>
